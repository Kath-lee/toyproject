 ...
 //$_GET['bno']이 있어야만 글삭제가 가능함.
	if(isset($_GET['no'])) {
		$no = $_GET['no'];
			...
			$del_sql = "select * from re_qna where no = '$no'";
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/qna_re_delete_form.css">
  <!-- index css/script -->
  <script>
		...
		<div class="tab_content">
			<h2>QnA 게시판</h2> <br/><br/>
				<div class="delete_form">			
					<form action="./re_delete_update.php" method="post" name="board_form">
