...
<head>
  ...
  <script>
	...
	//비밀번호
	var pwval = /^[a-zA-Z0-9]*$/;
	if(!pwval.test(document.myt_re_pw.fpasswd.value)){window.alert('비밀번호는 최대 16자 대,소문자,숫자,특수기호만 입력가능합니다.'); return;}
	document.myt_re_pw.submit();
	}
	</script>
</head>
<body>
  <div id="wraper">
	...
	<!--회원정보 수정 비번확인-->
      ...
      <div class="re_pw">
      	...
      	<form name="myt_re_pw" action="myt_re_pw_action.php" method="post">
