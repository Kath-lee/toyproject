...
<body class="a_menu2">
  <div id="wraper">
    ...
    <section class="tab1">	
		...
		<form class="my_info" name="member_form_modify" action="re_pw.php" method="post">
			<div class="input_400px">
				<p>아이디</p><span><?echo $memarr[m_id];?></span><br/>
				<!--<p>비밀번호</p><input type="password" name="fpasswd" id="fpasswd" placeholder="최대 16자 대,소문자,숫자, 특수기호를 사용해주세요" size="12" maxlength="10"value="<?echo $memarr[m_pass];?>"><br/>-->
				...
				<p>이름</p><span class="value"><?echo $memarr[m_name];?></span><br/>
				<p>휴대폰</p><span class="value"><?echo $memarr[m_phone];?></span><br/>
				<p>이메일</p><span class="value"><?echo $memarr[m_email];?></span><br/>
			</div>
			<div class="input_190px">
				<p>주소</p><span class="value"><?echo $memarr[m_postcode1];?></span>
				<span class="dashline">-</span>
				<span class="value"><?echo $memarr[m_postcode2];?></span>
				<!--<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기">-->
			</div>
			<div class="input_400px2">
				<p>도로명 주소</p><span class="value"><?echo $memarr[m_roadaddr];?></span><br/>
				<p>지번</p><span class="value"><?echo $memarr[m_jibunaddr];?></span><br/>
				<p>상세주소</p><span class="value"><?echo $memarr[m_detailaddr];?></span>
			</div>
			<span id="guide" style="color:#999"></span>
			<div class="subbtn">
				<!--<input type="reset" name="reset" value="내용 비우기"/>-->
				<!--<input type="button" name="button" name="cancel" value="수정 취소하기" onclick="location.href='../index.php'">-->
